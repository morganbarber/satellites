...
from ccsds.exceptions import CRCError, PayloadError, ValidationError
...
def parse_response_payload(raw_bytes: bytes) -> SpacePacket:
    ...
    except (ValidationError, CRCError, TypeError, ValueError, struct.error):
        pass
    ...
    except (ValidationError, TypeError, ValueError, struct.error):
        pass
